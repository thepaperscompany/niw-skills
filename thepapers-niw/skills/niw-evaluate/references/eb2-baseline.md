...
- **Statutory basis:** INA § 203(b)(2), 8 U.S.C. § 1153(b)(2). EB-2 is the second employment-based preference for members of the professions holding advanced degrees and individuals of exceptional ability.
- **Regulations:** 8 C.F.R. § 204.5(k)(1)–(3). Defines advanced degree, profession, and exceptional ability.
- **Profession statutorily defined:** INA § 101(a)(32).
- **Policy Manual:** USCIS Policy Manual Vol. 6 Pt. F Ch. 5(D)(1).
- **Specialty alignment to occupation:** *Matter of Katigbak*, 14 I&N Dec. 45, 46 (Reg. Comm. 1971).
- **Burden:** preponderance of evidence on the petitioner. *Matter of Chawathe*, 25 I&N Dec. 369, 375–76 (AAO 2010).
...
| Credential | Qualifies as EB-2 advanced degree? |
|---|---|
| U.S. master's degree or higher | Yes |
| U.S. Ph.D. | Yes |
| U.S. JD, MD, DDS, PharmD, and similar professional doctorates | Yes |
| Foreign master's-or-higher recognized as equivalent to a U.S. master's | Yes, with a credential evaluation showing equivalence |
...
**Experience must be "in the specialty"** related to the bachelor's degree and to the proposed endeavor. *See Matter of Katigbak*. A bachelor's in chemistry + five years as a restaurant manager does not equate to a chemistry master's for purposes of a chemistry-related endeavor.

**What qualifies as a profession:** an occupation listed in INA § 101(a)(32) (architects, engineers, lawyers, physicians, surgeons, teachers in elementary or secondary schools, colleges, academies, or seminaries) **or** any occupation that requires a U.S. bachelor's degree (or foreign equivalent) as the minimum requirement for entry into the occupation. 8 C.F.R. § 204.5(k)(2).
...
2. Letters from current or former employers documenting at least ten years of full-time experience in the occupation for which the petitioner is being sought.
3. A license to practice the profession, or certification for a particular profession or occupation.
4. Evidence that the petitioner has commanded a salary or other remuneration for services that demonstrates exceptional ability.
...
- If user has a master's (any country, with credential evaluation as needed): baseline can hold under Route 1.
...
- If specialty and endeavor share skills, knowledge, or expertise: baseline can hold.
- If unrelated: baseline fails for purposes of the NIW. The endeavor or the exceptional-ability claim would need to be reframed.

## How to communicate a failed baseline

When the baseline check fails, **say so directly** before running any NIW analysis. The user is better served by knowing this now than by receiving a NIW evaluation that depends on an assumption that does not hold.

Suggested language:

```text
EB-2 BASELINE CHECK: AT RISK

Before I evaluate your NIW case, I want to flag a foundational issue.

EB-2 baseline eligibility requires one of two things:

  (1) An advanced degree (U.S. master's or higher, or a foreign
      equivalent, or a U.S. bachelor's plus five years of progressive
      experience in the specialty), AND the occupation underlying
...
Based on what you have described:
  ...
  - [Specific issue 1, with citation]
  - [Specific issue 2, with citation]

What this means: if EB-2 baseline eligibility cannot be established,
NIW is not available regardless of how strong the Dhanasar prongs
otherwise look. This is statutory, not discretionary.

What would change this:

  - [Specific evidence that would address the issue]
  - [Or an alternative framing the user could pursue]

Before I evaluate the NIW prongs, please share any of the above
...
Some cases have baseline questions that cannot be resolved without external evidence (for example, a credential evaluation has not yet been done). In those cases:
