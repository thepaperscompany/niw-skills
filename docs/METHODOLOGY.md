...
**What the corpus is.** The complete public pool of AAO non-precedent NIW (EB-2/B5) decisions issued 2025-01 through 2026-06. The distillation is published in [`knowledge/current-adjudication-bar.md`](../knowledge/current-adjudication-bar.md) so you can check it rather than take our word for it.

**Quotations are verbatim.** Every quotation in that file is reproduced from its source decision, not generated from memory. This matters because the Stanford RegLab study found leading commercial legal-research tools hallucinate 17 to 33 percent of the time even with retrieval and grounding. A quotation you can look up is a stronger guarantee than a promise about runtime behavior.
